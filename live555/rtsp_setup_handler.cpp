// custom RTSP SETUP handler sample
#include <string>
#include <stdexcept>
#include <iostream>
#include <cassert>
...
public:
	...
	public:
		...
		void handleCmd_SETUP(RTSPClientConnection * conn, char const * urlPreSuffix, char const * urlSuffix, char const * fullRequestStr);
	};
...
void custom_rtsp::custom_client_session::handleCmd_SETUP(RTSPClientConnection * conn, char const * urlPreSuffix, char const * urlSuffix, char const * fullRequestStr)
{
	cout << "hello from SETUP handler" << std::endl;
	RTSPClientSession::handleCmd_SETUP(conn, urlPreSuffix, urlSuffix, fullRequestStr);
}
