// move window sample (with xcb_configure_window() after it is created)
#include <stdlib.h>
#include <stdio.h>
#include <xcb/xcb.h>
...
main ()
{
	...
	// move window to 100, 500 position
	uint32_t position[] = {100, 500};
	xcb_configure_window(connection, window, XCB_CONFIG_WINDOW_X|XCB_CONFIG_WINDOW_Y, position);
