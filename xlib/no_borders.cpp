...
void no_border(Display * disp, Window win)
{
	Atom atom = XInternAtom(disp, "_NET_WM_WINDOW_TYPE_DOCK", False);
	XChangeProperty(disp, win, XInternAtom(disp, "_NET_WM_WINDOW_TYPE", False),
